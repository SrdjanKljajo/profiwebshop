          ...
          <Card>
            <ListGroup variant='flush'>
              ...
              <ListGroup.Item>
                <Row>
                  <Col>Artikli</Col>
                  <Col>RSD {order.itemsPrice}</Col>
                </Row>
              </ListGroup.Item>
              <ListGroup.Item>
                <Row>
                  <Col>Poštarina</Col>
                  <Col>RSD {order.shippingPrice}</Col>
                </Row>
              </ListGroup.Item>
              <ListGroup.Item>
                <Row>
                  <Col>Porez</Col>
                  <Col>RSD {order.taxPrice}</Col>
                </Row>
              </ListGroup.Item>
              <ListGroup.Item>
                <Row>
