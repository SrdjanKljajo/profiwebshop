...
const ProductEditScreen = ({ match, history }) => {
  ...
  return (
    <>
      ...
      <FormContainer>
        <h1>dodajte/izmenite artikal</h1>
        ...
        {loading ? (
          ...
          <Form onSubmit={submitHandler}>
            ...
            <Form.Group controlId='brand'>
              <Form.Label>Brend artikla</Form.Label>
              <Form.Control
                type='text'
            ...
            <Form.Group controlId='countInStock'>
              <Form.Label>Količina artikala na stanju</Form.Label>
              <Form.Control
                type='number'
                placeholder='Unesite količinu artikala'
                value={countInStock}
